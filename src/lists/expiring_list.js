...
import { exipiringProducts } from "../controllers/stock_controller";

export const ExpiringList = ({ refresh, uuid }) => {
  ...
  useEffect(() => {
    exipiringProducts().then((data) => setProducts(data));
